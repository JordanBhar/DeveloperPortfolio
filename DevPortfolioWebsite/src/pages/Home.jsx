          ...
          <div className="flex flex-col md:flex-row space-y-5 md:space-y-10 md:space-x-40">
            ...
            <div className={`${styles.containers} md:w-3/4 space-y-5 md:space-y-10`}>
              ...
              <div className={`${styles.row} items-center gap-x-2`}>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="white" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                </svg>
                <p className={styles.regularText}>Toronto, Ontario</p>
              </div>
