      ...
      <div className={`${styles.paddingX} ${styles.flexCenter}`}>
        ...
        <div className={`${styles.boxWidth}`}>
          ...
          <div className="flex flex-col justify-center space-x-20 md:flex-row">
            ...
            <div className="md:w-3/4 space-y-10 bg-acrylic rounded-lg shadow-2xl p-10">
              ...
              <div className="flex flex-row items-center gap-x-2 text-l text-white ">
              ...
              <div className="pt-[50px] flex flex-row space-x-5 justify-start">
                <a className="rounded-full bg-teal-400 text-white py-3 px-4 text-xl" href="#">
                ...
                <a className="rounded-full bg-teal-400 text-white py-3 px-5 text-xl" href="#">
                  <div className="flex flex-row items-center gap-x-2">
            ...
            <div className=" p:invisible md:visible flex justify-center">
              <img src={profile} className="h-[26em] w-[22em] shrink rounded-lg shadow-2xl border-2  " alt="Profile"/>
            </div>
